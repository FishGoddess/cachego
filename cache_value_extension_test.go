...
func TestCacheValueString(t *testing.T) {
    value := NewCacheValue("str", true, DefaultLife)
    if value.String() != "str" {
...
func TestCacheValueInt8(t *testing.T) {
    value := NewCacheValue(int8(123), true, DefaultLife)
...
func TestCacheValueInt16(t *testing.T) {
    value := NewCacheValue(int16(123), true, DefaultLife)
...
func TestCacheValueInt32(t *testing.T) {
    value := NewCacheValue(int32(123), true, DefaultLife)
...
func TestCacheValueInt64(t *testing.T) {
    value := NewCacheValue(int64(123), true, DefaultLife)
...
func TestCacheValueFloat32(t *testing.T) {
    value := NewCacheValue(float32(123.123), true, DefaultLife)
...
func TestCacheValueFloat64(t *testing.T) {
    value := NewCacheValue(123.123, true, DefaultLife)
